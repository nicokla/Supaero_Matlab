function [ image, imageGris, good, bad, Mx, My ] = ...
    getImageAndMask( nameFolder, nameFile, meanSizeSide, colorBad )
% If meanSizeSide est plus grand que le côté moyen de l'image
% alors l'image n'est pas redimensionnée.
% Si colorbad n'est pas donné en entrée, il est par defaut vert.
% La zone de l'image qui est verte est considérée comme le masque.
